...
public class LoginCommand extends CommandBase
{
	...
	public void processPlayer(EntityPlayerMP player, String[] args)
	{
		...
		{
			player.addChatMessage(McColor.darkRed + Language.translate("You did not register."));
			return;
		}

		if(!CommonProxy.waitMap.containsKey(player))
		{
			player.addChatMessage(McColor.darkRed + Language.translate("You have already logged in."));
			return;
		}
		...
		if(args.length != 1)
		{
			...
			player.addChatMessage(McColor.green + Language.translate("/login password"));
			return;
		}
	...
	public static void login(EntityPlayerMP player)
	{
		...
		if(handler != null)
		{
			...
			player.addChatMessage(McColor.green + Language.translate("You have been logged in."));
