		...
		for(MethodNode targetMethod : targetCN.methods)
		{
			for(MethodInfo targetMethodInfo : patchInfo.targetMethods)
			{
						...
						&& (targetMethod.desc.equals(targetMethodInfo.desc) || targetMethod.desc.equals(targetMethodInfo.mappedDesc)))
				{
					...
					System.out.println("[fihgu's Core Mod] "+targetMethod.name+" = "+targetMethodInfo.name+" || "+targetMethodInfo.mappedName);
					System.out.println("[fihgu's Core Mod] "+targetMethod.desc+" = "+targetMethodInfo.desc+" || "+targetMethodInfo.mappedDesc);
					System.out.println("[fihgu's Core Mod] Patched: "+targetMethodInfo.name+"@"+targetMethodInfo.desc);
					patched = true;
				}
			}
		}
