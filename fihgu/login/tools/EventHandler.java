...
public class EventHandler 
{
	...
	public void onPlayerLogin(PlayerLoginEvent e)
	{
		...
		else
		{
			...
			par2EntityPlayerMP.addChatMessage(McColor.green + Language.translate("Please /login or /register."));
		}
	}
	...
	public void onTryCommand(TryCommandEvent e)
	{
		if(e.sender instanceof EntityPlayerMP)
		{
			if(CommonProxy.waitMap.containsKey((EntityPlayerMP)e.sender))
			{
				...
				{
					e.setCanceled(true);
					e.sender.sendChatToPlayer(ChatMessageComponent.createFromText(McColor.darkRed + Language.translate("You must /login or /register before you can use any command!")));
				}
			}
		}
	}
