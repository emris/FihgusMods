...
public class CommonProxy 
{
	...
	private void createDefaultPermission()
	{
		...
		temp.data.add("lock");
		temp.data.add("lock.*" + allNode  + "*");
		temp.data.add("unlock");
		temp.data.add("unlock.*" + allNode  + "*");
		temp.data.add("share");
		temp.data.add("share.*" + allNode  + "*");
		temp.data.add("unshare");
		temp.data.add("unshare.*" + allNode  + "*");
		temp.data.add("back");
		temp.data.add("back.*" + allNode + "*");
		temp.data.add("home");
		temp.data.add("home.*" + allNode + "*");
		temp.data.add("sethome");
		temp.data.add("sethome.*" + allNode + "*");
		temp.data.add("warp");
		...
		temp.data.add("setwarp.*" + allNode + "*");
		temp.data.add("delwarp");
		temp.data.add("delwarp.*" + allNode + "*");
		temp.data.add("clear");
